...
<main>
  <article class='content'>
    ...
    <section class='post'>
      <div class='language'><a class='language__link language--active' href="{{ site.url | append: '/the-path' }}">EN</a><a class='language__link' href="{{ site.url | append: '/es/the-path' }}">ES</a></div>
  ...
  <footer>
    <small>The Grid Report is a publication by ROGUES.</small>
  </footer>
</main>
